...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/kronikpillow/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/kronikpillow/LARBS/master/progs.csv"
...
adduserandpass() { \
	...
	usermod -a -G audio,input,kvm,storage,video,network,log,rfkill,sys,uucp,wheel,dbus,lp,mail "$name" && mkdir -p /home/"$name" && chown "$name":wheel /home/"$name"
